...
<header id="header" class="alt skel-layers-fixed">
				<h1><a href="${request.contextPath}/" style="font-size:21px;" ><b style="color:white;" >Findih - <span> Find the best tutorials based on other geeks's votes </span></b></a></h1>
				<br>
				<nav id="nav">
				</nav>
			</header>
		...
		<!-- Banner -->
			<section id="banner">
				<div class="inner" align=center >
					<h2 style="font-family:Georgia;">There is no such thing  . <br> ${errorMsg } <br> <a href="${request.contextPath}/" >Go home</a> </h2> 	
