				...
				<div class="inner" align=center >
					<h2 style="font-family:Georgia;">Please sign in </h2> 	
					  	<form:form action="/clap/user/auth" modelAttribute="userAuth" method="POST">
							...
							<label style="font-family:Georgia;font-size:21px;" >Password : </label> 
							...
							<br>
							<input type="submit" class="formSubmit" style="background-color:white;" value="sign in" />
					</form:form>
					<b><font color="#ff9900">${error }</font></b>
				</div>
			</section>
<footer> 
